            ...
            <div class="login-box">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
                    ...
                    <el-form-item prop="MApasswordnew" label="新密码">
                        ...
                        <el-input v-model="ruleForm.MApasswordnew" placeholder="输入新密码" type="password"
                                  class="m-input"></el-input>
                        <!--<i class="icon-pwd icon-r"></i>-->
                    </el-form-item>
                    <el-form-item prop="MApasswordnewrepeat" label="旧密码">
                        <span class="icon-pwd icon"></span>
                        <el-input v-model="ruleForm.MApasswordnewrepeat" placeholder="重复新密码" type="password"
                                  class="m-input"></el-input>
                        <!--<i class="icon-pwd icon-r"></i>-->
                    </el-form-item>
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post(api.forget_password, that.ruleForm).then(res => {
